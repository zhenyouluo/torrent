#ifndef TORRENT_PROTOCOL_REQUESTPROTO_H_
#define TORRENT_PROTOCOL_REQUESTPROTO_H_
#include <torrent/protocol/ProtoBase.h>

namespace torrent {

class RequestProto : public ProtoBase{
public:
    RequestProto():ProtoBase()
    {
    }
    ~RequestProto(){}
